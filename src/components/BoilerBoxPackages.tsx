import { CheckCircle, Package, Tablet, Layers, Crown } from "lucide-react";
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-gray-800">
                {[
                  { label: "Micro Computer", values: [1, 1, 1, 1] },
                  { label: "Tablets Included", values: ["0", "10", "20", "20"] },
                  { label: "Tablet Type", values: ["N/A", "Packard Bell", "Packard Bell", "Lenovo"] },
                  { label: "Simultaneous Learners", values: [20, 20, 20, 20] },
                  { label: "Moodle LMS", values: ["Yes", "Yes", "Yes", "Yes"] },
                  { label: "Configuration & Setup", values: ["Yes", "Yes", "Yes", "Yes"] },
                  { label: "Training Materials", values: ["Yes", "Yes", "Yes", "Yes"] },
                  { label: "Offline Capable", values: ["Yes", "Yes", "Yes", "Yes"] },
                ].map((row, idx) => (
